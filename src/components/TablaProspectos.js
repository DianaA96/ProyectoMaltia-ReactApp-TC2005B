            ...
            <tbody>
              <tr key={registro.idProspect}>
                ...
                <td>
                  <CustomLink 
                    tag='button' 
                    to={`./editarProspecto/${registro.idProspect}`} 
                    id="botonEditarProspecto"><i 
                    className="fas fa-user-edit"></i>
                  </CustomLink>
                </td>
                <td>
                  <button 
                    name={registro.idProspect} 
                    onClick={showModal} 
                    tag='button' 
                    id="botonContactarProspecto">
                ...
                <td>
                  <CustomLink 
                    tag='button' 
                    to={`/solicitudCliente/${registro.idProspect}`} 
                    id="botonIniciarSolicitudProspecto">
